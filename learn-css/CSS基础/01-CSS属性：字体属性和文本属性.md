...
<font color="#ee66cc">**CSS中的单位是必须要写的**，因为它没有默认单位。</font>
...
- `color:red;` 字体颜色
- `text-align: center;` 在当前容器中的对齐方式。属性值可以是：left、right、center（<font color="#ff66">**在当前容器的中间**</font>）、justify
- `text-transform: lowercase;` 单词的字体大小写。属性值可以是：`uppercase`（单词大写）、`lowercase`（单词小写）、`capitalize`（每个单词的首字母大写）
- `text-indent` 元素中文本首行缩进
...
![](https://user-images.githubusercontent.com/30429680/111117030-e3064580-85a1-11eb-8d06-d22be40dd765.png)
